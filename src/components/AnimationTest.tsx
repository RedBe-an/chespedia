  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div
          className="p-6 bg-primary text-primary-foreground rounded-lg animate-slideInUp"
          style={{
        ...
        <div
          className="p-6 bg-accent text-accent-foreground rounded-lg animate-fadeInLeft"
          style={{
        ...
        <div
          className="p-6 bg-secondary text-secondary-foreground rounded-lg animate-bounceIn"
          style={{
        ...
        <div
          className="p-6 border rounded-lg animate-rotateIn"
          style={{
        ...
        <div
          className="p-6 rounded-lg animate-zoomIn"
          style={{
